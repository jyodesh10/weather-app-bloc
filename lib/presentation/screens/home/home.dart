            ...
            children: [
              Column(
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      text: weatherState.current.tempC.toString().split('.')[0],
                      style: headingStyle.copyWith(fontSize: 50, fontWeight: FontWeight.bold),
                      children: [
                        TextSpan(
                          text: "°C",
                          style: headingStyle.copyWith(fontSize: 30, fontWeight: FontWeight.bold),
                        )
                      ]
                    ) 
                  ),
              ...
              Hero(
                tag: 'day',
                child: Image.network(
                  weatherState.current.condition.icon.toString().replaceAll(RegExp(r'//'), 'https://'),
                  // "assets/weather.png",
                  height: 60,
                ),
              )
